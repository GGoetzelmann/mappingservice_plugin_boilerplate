package edu.kit.datamanager.mappingservice.plugins.boilerplate;
...
public class DemoPlugin implements IMappingPlugin{

    private static String version;

    private final Logger LOGGER = LoggerFactory.getLogger(DemoPlugin.class);
    ...
    public MappingPluginState mapFile(Path mappingFile, Path inputFile, Path outputFile) throws MappingPluginException {
        ...
        LOGGER.trace("Run {} on '{}' with mapping '{}' -> '{}'", NAME, mappingFile, inputFile, outputFile);
